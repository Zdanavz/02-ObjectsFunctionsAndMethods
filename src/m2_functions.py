...
def main():
    print(hyp(4,4))
    #i_like_turtles('red', 10)
    i_like_turtles('blue', 15)
...
# New: call the function once then comment it out, then call it again with different values
#
###############################################################################

def i_like_turtles(a, b):
    window=rg.TurtleWindow()
    t1=rg.SimpleTurtle()
    t1.pen=rg.Pen('green',b)
    t2=rg.SimpleTurtle()
    t2.pen=rg.Pen(a, 5)
    t1.forward(100)
    t2.backward(100)
